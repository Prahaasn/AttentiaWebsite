            ...
            <StaggerItem key={index} className="relative">
              <div className="text-center">
                ...
                <div className="relative inline-flex mb-6">
                  <div className="w-20 h-20 rounded-full bg-white shadow-lg flex items-center justify-center relative z-10">
                    <Icon className="w-8 h-8 text-primary-purple" />
                  </div>
                  <span className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-gradient-primary flex items-center justify-center text-white text-sm font-bold z-20">
                    {step.number}
                  </span>
                </div>
